// ----------- plot  -------------
  ...
  var degreedata = 'dataset/high.csv';
  var year = 2000;
  var setdata;
  ...
  var load = function() {
      ...
      if(metric == "Bachelor's degree or more"){
        degreedata ='dataset/bachelor.csv';
      }else if( metric == "Advanced degree or more"){
        degreedata ='dataset/advance.csv';
      // }else if(metric=="High school graduate or more"){
      }else{
        degreedata ='dataset/high.csv';
      }
  ...
  function degreecolor(degreedata) {
    if(degreedata =='dataset/advance.csv') {
      color1 = "#fee0d2";
      color2 = "#cb181d";
      colors=[];
      valuetocolors(colors,color1,color2);
    } else if (degreedata =='dataset/bachelor.csv') {
      color1 = "#f2f0f7";
      color2 = "#4B0082";
      colors=[];
      valuetocolors(colors,color1,color2);
...
// --- set domain for quantize
    if(degreedata =='dataset/high.csv') {
      domain_max=95;
      domain_min=70;
    } else if(degreedata =='dataset/bachelor.csv') {
      domain_max=50;
